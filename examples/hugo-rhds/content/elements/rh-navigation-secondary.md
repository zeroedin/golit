...
<p>8 demos for <code>&lt;rh-navigation-secondary&gt;</code></p>
...
<rh-navigation-secondary id="navigation-secondary-current-page"
                         role="navigation">
  <a href="#" slot="logo" id="logo-id" aria-current="page">
    Logo/Title
  </a>
...
<rh-navigation-secondary id="navigation-secondary-dark"
                         color-palette="dark"
                         role="navigation"
                         aria-label="main">
  <a href="#" slot="logo" id="logo-id" aria-current="page">
...
<rh-navigation-secondary dir="rtl">
  <a href="#"
     slot="logo"
     id="logo-id"
     aria-current="page">לוגו</a>
  <ul slot="nav"
      aria-labelledby="logo-id">
    <li>
      <rh-navigation-secondary-dropdown>
        <a href="#dropdown-fallback-url"
           slot="link">תפריט</a>
        <rh-navigation-secondary-menu slot="menu">
          <rh-navigation-secondary-menu-section>
...
<rh-navigation-secondary id="navigation-secondary-demo"
                         role="navigation">
  <a href="#" slot="logo" id="logo-id" aria-current="page">
    Logo/Title
  </a>
